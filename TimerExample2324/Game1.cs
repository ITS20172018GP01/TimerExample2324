...
namespace TimerExample2324
{
    public class Game1 : Game
    {
        ...
        TimeSpan _countDown = TimeSpan.FromSeconds(10);
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if(_countDown.Seconds <= 0) Exit();
            // Calculate the update speed as a function of the visible time
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            _spriteBatch.DrawString(message, _countDown.Seconds.ToString(), new Vector2(_textPos.X, _textPos.Y - 25), _color);
            _spriteBatch.End();
